...
```{r fig-ID-1, echo=FALSE, fig.cap=CAPTION, out.width=400}
...
```{r fig-ID-2, echo=FALSE, fig.cap=CAPTION, out.width=400}
...
```{r fig-ID-3, echo=FALSE, fig.cap=CAPTION, out.width=400}
...
```{r fig-ID-4, echo=FALSE, fig.cap=CAPTION, out.width=400}
...
```{r demo-chunk-add-1, echo=FALSE, fig.cap=CAPTION, out.width=400}
